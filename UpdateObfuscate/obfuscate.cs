...
{
    public partial class obfuscate : Form
    {
        public obfuscate()
        {
            InitializeComponent();
        ...
        private void obfuscate_Load(object sender, EventArgs e)
        {
            ...
            {
                AutoUpdater.Start("https://raw.githubusercontent.com/lils0uxz/UpdateObfuscate/master/Updater.xml");
            };
            timer.Start();
